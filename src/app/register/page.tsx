            ...
            <div className="flex min-h-full flex-col justify-center px-6 lg:px-8 mt-[2rem] mb-[2rem]">
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-4" action="#" method="POST">
                        ...
                        <div>
                            <label htmlFor="alternate1" className="block text-sm font-medium leading-6 text-white">候補團員一 DC ID<span className="text-red-500 ml-[0.2rem]">*</span></label>
                            <div className="mt-2">
                                <input id="alternate1" name="alternate1" type="text" placeholder="haco.tw" required className="bg-white block w-full rounded-md border-0 px-2 py-1.5 text-black shadow-sm sm:text-sm sm:leading-6" />
                            </div>
                        </div>
                        <div>
                            <label htmlFor="alternate2" className="block text-sm font-medium leading-6 text-white">候補團員二 DC ID<span className="text-red-500 ml-[0.2rem]">*</span></label>
                            <div className="mt-2">
                                <input id="alternate2" name="alternate2" type="text" placeholder="haco.tw" required className="bg-white block w-full rounded-md border-0 px-2 py-1.5 text-black shadow-sm sm:text-sm sm:leading-6" />
                            </div>
                        </div>
                        <div>
